...
namespace Academico.Controllers
{
    public class DisciplinaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DisciplinaID,Name,CargaHoraria")] Disciplina disciplina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DisciplinaID,Name,CargaHoraria")] Disciplina disciplina)
        {
