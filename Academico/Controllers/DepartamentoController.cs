...
namespace Academico.Controllers
{
    public class DepartamentoController : Controller
    {
        ...
        {
            var academicoContext = _context.Departamento.Include(d => d.Instituicao);
        ...
        {
            ViewData["InstituicaoID"] = new SelectList(_context.Instituicao, "InstituicaoID", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("DepartamentoID,Nome,InstituicaoID")] Departamento departamento)
        {
            ...
            ViewData["InstituicaoID"] = new SelectList(_context.Instituicao, "InstituicaoID", "Nome", departamento.InstituicaoID);
            return View(departamento);
        }
